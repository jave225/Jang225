...
public class Main {
	...
	public static void write(Board board) {
		...
		// 그렇치 않으면, 작성 불가
			...
			System.out.println("# 게시글이 목록이 꽉 찻습니다.");
		}
	}
	// 게시글 수정
	...
	public static void main(String[] args) {
		...
		do {
			...
			// 메뉴번호 입력
			menuNo = sc.nextInt();  // 1(앤터)
			sc.nextLine();          // 엔터를 버퍼에서 뺴준다.
			...
			break;
			// 게시글 읽기
			case 2 : System.out.print("제목 :");
			boardNo = sc.nextInt(); // 1(앤터)
			sc.nextLine();          // 앤터를 버퍼에서 제거
			read(boardNo);
			break;
			// 게시글 쓰기
			case 3: 
