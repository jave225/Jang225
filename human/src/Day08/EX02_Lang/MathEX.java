...
public class MathEX {
	...
	public static void main(String[] args) {
		...
		System.out.println(Math.PI);    // 3.14592653589793 (원주율)
		System.out.println(Math.ceil(3.125)); // 올림
		System.out.println(Math.floor(0)); // 내림
		...
		// Math.random()                      : 0.0 보다크거나 같고 1.0 보다 임의의 실수를 반환
		//Math.random()                       : 0.xxxx ~0.9xx
