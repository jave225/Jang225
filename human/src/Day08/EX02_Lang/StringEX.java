...
public class StringEX {
	...
	public static void main(String[] args) {
		...
		System.out.println(str1.equals(str2) );  // 믄자열이 일치하는지 확인 (true/ false)
		...
		System.out.println(str1.replace(" ", " # "));  // rerplace (" 기존문자", "대체문자")
		System.out.println(str1.replaceAll(" ", " * ") ); //rerplace 와 같음
		System.out.println(str1.toUpperCase() ) ; // 모두 대문자로 변경
		System.out.println(str1.toLowerCase() ) ; // 모두 소문자로 변경
		
		// spilt (" (구분자) ')      : (구분자)를 기준으로 문자열을 잘라서 배열로 반환
