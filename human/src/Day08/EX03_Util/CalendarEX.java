...
public class CalendarEX {
	...
	public static void main1(String[] args) {
		...
		System.out.println(calendar.get(Calendar.YEAR) + "년");  // 4자리의 년도
		System.out.println(calendar.get(Calendar.MONTH) + 1 + "월");  // 월(0~11)
		System.out.println(calendar.get(Calendar.DATE) + "일"); // 일 (1~31)
		
		System.out.println("현재 시간");
		System.out.println(calendar.get(Calendar.YEAR) + "시"); 
		System.out.println(calendar.get(Calendar.MONTH) + 1 + "분"); 
		System.out.println(calendar.get(Calendar.DATE) + "초");
